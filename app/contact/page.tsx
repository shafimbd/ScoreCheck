          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600">
                Ready to transform your credit assessment process? We'd love to hear from you.
              </p>
            </div>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">hello@scorecheck.ai</p>
                        <p className="text-gray-600">support@scorecheck.ai</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
